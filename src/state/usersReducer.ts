...
type ActionTypes = FollowAT | GetUsers | GetTotalUsersCountAT |SetCurrentPageAT
...
export const GetTotalUsersCountAC = (usersCount: number): GetTotalUsersCountAT => ({type: "GET-TOTAL-USERS-COUNT", payload: {usersCount}})
